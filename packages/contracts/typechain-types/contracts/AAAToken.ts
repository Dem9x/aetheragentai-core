...
export interface AAATokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "PAUSER_ROLE"
...
export interface AAAToken extends BaseContract {
  connect(runner?: ContractRunner | null): AAAToken;
  waitForDeployment(): Promise<this>;

  interface: AAATokenInterface;
