...
export interface ReentrantClaimerInterface extends Interface {
  getFunction(nameOrSignature: "attack" | "distributor"): FunctionFragment;
...
export interface ReentrantClaimer extends BaseContract {
  connect(runner?: ContractRunner | null): ReentrantClaimer;
  waitForDeployment(): Promise<this>;

  interface: ReentrantClaimerInterface;
